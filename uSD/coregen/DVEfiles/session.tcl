...
# DVE full session
# Saved on Thu Jul 19 17:29:42 2012
# Designs open: 0
...
# DVE version: E-2011.03-SP1
# DVE build date: Aug 17 2011 21:01:14


#<Session mode="Full" path="/afs/slac.stanford.edu/u/re/bklein/projects/microSD/coregen/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{23 43} {1922 1029}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 324]
set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier]
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 324
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 719
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 323} {height 719} {dock_state left} {dock_on_new_line true} {child_hier_colhier 281} {child_hier_coltype 58} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1899} {height 168} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 709} {child_data_colvalue 415} {child_data_coltype 448} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
