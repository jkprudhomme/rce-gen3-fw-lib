...
create_clock -name ethRxClk0 -period 4 [get_ports ethRxClk[0]]
create_clock -name ethRxClk1 -period 4 [get_ports ethRxClk[1]]
...
set_clock_groups -asynchronous -group [get_clocks CLKOUT1]        -group [get_clocks gmii_clk_125m_out]
set_clock_groups -asynchronous -group [get_clocks CLKOUT1]        -group [get_clocks gmii_clk_25m_out]
