...
xst -ifn xst.scr
copy zynq_gige_example_design.ngc .\results\

REM Copy the netlist generated by Coregen
echo 'Copy files from the netlist directory to the results directory'
copy ..\..\zynq_gige.ngc results

REM  Copy the constraints files generated by Coregen
echo 'Copy files from constraints directory to results directory'
copy ..\example_design\zynq_gige_example_design.ucf results\

cd results
echo 'Running ngdbuild'
ngdbuild zynq_gige_example_design

echo 'Running map'
map -ol high -timing zynq_gige_example_design -o mapped.ncd
...
netgen -ofmt vhdl -pcf mapped.pcf -sim -dir . -tm zynq_gige_example_design -w routed.ncd routed.vhd
