...
vlogcomp -work work -d SIMULATION -i --incremental -f board_vlog.f
...
fuse.exe work.boardi work.glbl -L unisims_ver -L unimacro_ver -L unisim -L unimacro -L secureip -o demo_tb.exe
